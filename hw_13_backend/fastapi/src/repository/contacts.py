...
async def search_contacts(skip: int, limit: int, query: str, user: User, db: Session) -> List[Contact]:
...
async def get_coming_birthday(skip: int, limit: int, user: User, db: Session) -> List[Contact]:
    today = date.today()
